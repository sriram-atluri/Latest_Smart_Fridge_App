...
public class PantryDBHelper extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "PantryData.db";
    public static final String TABLE_NAME = "PantryList";
    public static final String COL_1 = "ID";
    public static final String COL_2 = "PANTRY_ITEM";
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table " + TABLE_NAME + " (ID INTEGER PRIMARY KEY AUTOINCREMENT, PANTRY_ITEM TEXT, EXPIRY_DATE TEXT)");
    }
    ...
    {
        SQLiteDatabase db = this.getWritableDatabase();
        db.execSQL("DELETE FROM PantryList WHERE ID='"+get_ID+"'");
    }
    ...
    public ArrayList<InventoryItem> getItems() {
        ...
        if (cursor.moveToFirst()) {
            do {
                InventoryItem pantryItem = new InventoryItem();
                pantryItem.setName(cursor.getString(1));
                pantryItem.setExpiryDate(cursor.getString(2));
                arrayList.add(pantryItem);
    ...
    public int GetId(String entry) {
        ...
        Cursor getId = myDB.rawQuery("select ID from " + TABLE_NAME + " where PANTRY_ITEM = '"+ entry +"'",null);
