...
public class AboutPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.aboutActivityContainer, aboutFragment).commit();
...
// Replace the contents of the container with the new fragment
            ft.replace(R.id.aboutActivityContainer, new NotificationsFragment());
